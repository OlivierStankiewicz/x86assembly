...
wyswietl_EAX_hex PROC
			...
			mov		ebp, esp				; zapisanie w ebp adresu zarezerwowanego obszaru
			
			mov		ecx, 8					; tyle bedzie obiegow petli, bo w EAX jest 8*4 bity
			mov		esi, 0					; index poczatkowy do zapisu cyfr
			mov		edi, 0					; licznik ile znakow jest niewykorzystanych

; petla skipujaca zera z przodu
ptl_zera:	rol		eax, 4					; przesuniecie bitow liczby, tak by do 'ramki' odczytu weszly teraz rozpatrywane (w 1. obiegu beda to najstarsze)
			...
			jnz		przejscie				; przejscie do normalnego zapisu cyfr przy pierwszym wystapieniu niezera

			inc		edi						; dodanie znaku do pominiecia na koniec
			loop	ptl_zera
			jmp		wysw_hex				; jesli nie napotkal niezera przeskakujemy do wyswietlania
...
przejscie:	mov		dl, dekoder_hex[ebx]	; zapisanie do dl odpowiedniej reprezentacji cyfry dla hex
			mov		[ebp][esi], dl			; zapisanie do obszaru roboczego na stosie cyfry
